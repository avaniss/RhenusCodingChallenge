...
public class ExceptionHandlingMiddleware : IMiddleware
{
    ...
    /// <param name="context">The http context.</param>
    /// <param name="exception">The raised exception.</param>
    private void HandleConflictException(HttpContext context, Exception exception)
    {
        context.Response.StatusCode = StatusCodes.Status409Conflict;
        context.Response
            .WriteAsJsonAsync((exception as ConflictException)!.Message)
            .GetAwaiter()
            .GetResult();
    }
    ...
    /// <param name="context">The http context.</param>
    /// <param name="exception">The raised exception.</param>
    private void HandleUnauthorizedException(HttpContext context, Exception exception)
    {
        context.Response.StatusCode = StatusCodes.Status401Unauthorized;
        context.Response
            .WriteAsJsonAsync((exception as UnauthorizedException)!.Message)
            .GetAwaiter()
            .GetResult();
    }
